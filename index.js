...
const completed = document.querySelector('#complete-task');
...
date.innerHTML = today.toLocaleDateString ('en-UK', {weekday : 'long', day:'numeric', month:'long', year:'numeric'});

//creamos la función para agregar las tareas a la lista
function addTaskFunction (task,id,done) {
